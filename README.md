...
" trong phần thành thành tích, những mục nhỏ xuống dòng riêng
 dự án chính thì khi click vào sẽ hiện rõ thông tin và hình ảnh ở giữa web
ở phần hành trình 
năm 2020 Phát Triển Công Cụ Thiết Kế Tự Động
khi nhấn vào sẽ khung nhỏ hiện mô tả chi tiết
...
2. **Test**: Chạy trên browsers khác nhau ở Chrome
